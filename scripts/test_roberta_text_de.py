...
class TextDeTester:
    ...
    def plot_confusion_matrix(self, cm, output_path):
        ...
        plt.title("Confusion Matrix - RoBERTa Text DE")
    ...
    def test(
        ...
        checkpoint_dir: Path,
        batch_size: int = 32,
        output_dir: Path = Path("results/roberta_text_de"),
    ):
        ...
        print("\n" + "=" * 80)
        print("TEST RESULTS - RoBERTa Text DE")
        print("=" * 80)
...
def main():
    parser = argparse.ArgumentParser(description="Testeaza un checkpoint RoBERTa Text DE")
    parser.add_argument("--checkpoint-dir", type=Path, default=Path("checkpoints/roberta_text_de"))
    parser.add_argument("--output-dir", type=Path, default=Path("results/roberta_text_de"))
    parser.add_argument("--transcript-json", type=Path, default=None, help="Calea catre Transcription_de JSON. Implicit: MSP_Podcast/Transcription_de.json")
    ...
    transcripts_de_json = args.transcript_json or (data_dir / "Transcription_de.json")

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train French text backbone for regression")
    parser.add_argument(
        "--checkpoint-dir",
        type=str,
        default="checkpoints/roberta_text_fr_regression",
...
def main():
    ...
    print("=" * 80)
    print("Loading MSP-Podcast French Text Data for Regression")
    print("=" * 80)
    ...
    trainer = TextRegressionTrainer(model_name="almanach/camembert-base")
    train_dataset = TextRegressionDataset(train_dataset_msp, trainer.tokenizer, text_fields=["text_fr", "text_en"], max_length=128, padding="max_length")
    val_dataset = TextRegressionDataset(val_dataset_msp, trainer.tokenizer, text_fields=["text_fr", "text_en"], max_length=128, padding="max_length")

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Spanish text backbone for regression")
    parser.add_argument(
        "--checkpoint-dir",
        type=str,
        default="checkpoints/roberta_text_es_regression",
...
def main():
    ...
    print("=" * 80)
    print("Loading MSP-Podcast Spanish Text Data for Regression")
    print("=" * 80)
    ...
    trainer = TextRegressionTrainer(model_name="pysentimiento/robertuito-sentiment-analysis")
    train_dataset = TextRegressionDataset(train_dataset_msp, trainer.tokenizer, text_fields=["text_es", "text_en"], max_length=128, padding="max_length")
    val_dataset = TextRegressionDataset(val_dataset_msp, trainer.tokenizer, text_fields=["text_es", "text_en"], max_length=128, padding="max_length")

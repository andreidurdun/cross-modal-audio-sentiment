...
def main() -> None:
    parser = argparse.ArgumentParser(description="Translate English transcripts to German")
    parser.add_argument("--input-path", type=Path, default=INPUT_PATH, help="Input English transcripts JSON")
    parser.add_argument("--output-path", type=Path, default=OUTPUT_PATH, help="Output German transcripts JSON")
